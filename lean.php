              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                  ...
                  <div class="header-title-text">
                    <a id="site-title" href="http://ptkat.nursing.ui.ac.id/thailand/" data-animation-role="header-element">SLOT THAILAND</a>
                  </div>
                </div>
                <!-- Nav -->
                  ...
                  <div class="header-nav-wrapper">
                    <nav class="header-nav-list">
                      <div class="header-nav-item header-nav-item--collection header-nav-item--active">
                        <a href="http://ptkat.nursing.ui.ac.id/thailand/" data-animation-role="header-element" aria-current="page">SLOT THAILAND</a>
                      </div>
                    </nav>
                  </div>
                </div>
